...
NgxPermissionsConfigurationService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: NgxPermissionsConfigurationService, deps: [{ token: USE_CONFIGURATION_STORE }, { token: i1.NgxPermissionsConfigurationStore }], target: i0.ɵɵFactoryTarget.Injectable });
